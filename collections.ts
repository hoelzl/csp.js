...
module collections {
    ...
    */
    ...
    export class MultiDictionary<K, V> {
        ...
        // Cannot do: 
        // class MultiDictionary<K,makeVariable> extends Dictionary<K,Array<makeVariable>> {
    ...
    export class Set<T>{
        ...
        /**
         * Pick any element of the set and return it.
         * @returns {any}
         */
        pickAny(): T {
            var result = this.dictionary.values()[0];
            this.dictionary.remove(result);
            return result;
        }
